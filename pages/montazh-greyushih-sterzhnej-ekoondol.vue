                ...
                <div class="columns">
                  ...
                  <div class="column is-full-mobile">
                    ...
                    <ul>
                      ...
                      <li>СаммёнгТех (Эко-Ондоль) — 15% от розницы</li>
                    </ul>
                    <div class="bordered">
    ...
    <div class="container">
      <div class="content">
        <section class="hero is-small">
          <div class="hero-body">
            <h2 class="title has-text-centered">Примеры работ, выполненные проекты<br/>#греющиестержни</h2>
            <br/>
            <br/>
            <br/>
  ...
  if (process.BROWSER_BUILD) {
    ...
    let feed = new Instafeed({
      ...
      filter: function(image) {
        ...
        // Return array.
        if (image.tags.indexOf('греющиестержни') >= 0 || image.tags.indexOf('гдеремонтанет') >= 0) {
          return true;
        }
      },
      after: function() {
