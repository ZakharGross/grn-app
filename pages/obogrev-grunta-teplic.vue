<template>
  <div class="service-page">
		<div class="service-obogrev-teplic-background">
						...
						<div class="hero-body">
				  		<div class="columns">
				  			<div class="column">
				  				...
				  				<h1 class="title is-green">Обогрев грунта, теплиц</h1>
								</div>	  				
				  			<div class="column">
				  				<p>Сложная задача, но у меня есть опыт расчета и монтажа греющего кабеля в грунт. Я использую проверенный саморегулирующийся кабель с терморегулятором, который при правильном монтаже даёт нужную температуру на поверхности грунта.</p>
				  			</div>
				  		</div>
			  		</div>
			  	</section>
                ...
                <div class="columns">
                  <div class="column is-full-mobile">
                    ...
                    <table class="table is-striped">
                      <tbody>
                        <tr><td>Монтаж греющего кабеля</td><td>80 руб./пог.м</td></tr>
                  ...
                  <div class="column is-full-mobile">
                    ...
                    <ul>
                      <li>Я не буду устанавливать греющий кабель, который не предназначен для уличного использования;</li>
      ...
      <div class="content">
        <section class="hero is-small">
          <div class="hero-body">
            ...
            <h4 class="subtitle has-text-centered"><a href="https://www.instagram.com/gderemonta_net/" target="_blank">@gderemonta_net</a> #обогревгрунта</h4>
            <br/>
            <br/>
            <br/>
...
<script>
  ...
  export default {
    ...
    head () {
      return {
        title: 'Обогрев грунта, теплиц. Установка систем обогрева',
        meta: [
          {
          	hid: 'description', name: 'description', 
          	content: 'Сложная задача, но у меня есть опыт расчета и монтажа греющего кабеля в грунт. Я использую проверенный саморегулирующийся кабель с терморегулятором, который при правильном монтаже даёт нужную температуру на поверхности грунта.'
          },
          {
          	hid: 'keywords', name: 'keywords', 
          	content: 'обогрев грунта, обогрев теплиц, установка систем обогрева'
          }
        ]
      }
    }
