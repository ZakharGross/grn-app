                ...
                <div class="columns">
                  <div class="column is-full-mobile">
                    ...
                    <table class="table is-striped">
                      <tbody>
                        <tr>
	                        <td>
	                        	Монтаж сважинного насоса «под ключ»<br/>
	                        	<ul>
	                        		<li>Скважина
	                        			<ul>
	                        				<li>Подключение питания насоса;</li>
	                        				<li>Монтаж ПНД трубы к насосу;</li>
	                        				<li>Монтаж страховочного тросса</li>
	                        				<li>Монтаж оголовка/крышки скважины;</li>
	                        				<li>Монтаж адаптера на скважину;</li>
	                        			</ul>
	                        		</li>
	                        		<li>Дом
	                        			<ul>
	                        				<li>Подключение к основной системе водоснабжения;</li>
	                        				<li>Монтаж манометра;</li>
	                        				<li>Монтаж пульта управления;</li>
	                        				<li>Монтаж 2х кранов;</li>
	                        			</ul>
	                        		</li>
	                        	</ul>
	                      	</td>
                        ...
                        <tr><td>ПНД труба для воды (от дома к скважине)</td><td>100 руб./пог.м</td></tr>
                      </tbody>
                    </table>
                  ...
                  <div class="column is-full-mobile">
                    ...
                    <ul>
                      ...
                      <li>Прокладывайте силовой кабель в ПНД трубе, так гарантированно с ним ничего не случится;</li>
      ...
      <div class="content">
        <section class="hero is-small">
          <div class="hero-body">
            ...
            <h4 class="subtitle has-text-centered"><a href="https://www.instagram.com/gderemonta_net/" target="_blank">@gderemonta_net</a> #установканасоса</h4>
            <br/>
            <br/>
            <br/>
